 ...
 */
abstract class BaseTakePhotoActivity<T : BasePresenter> : BaseActivity<T>() , TakePhoto.TakeResultListener, InvokeListener {
...
//
//            onEnableCompress(config, showProgressBar)
        }
        return takePhoto!!
    }
